...
public class Draggable : MonoBehaviour
{
    ...
    private void Start()
    {
        pullForce = pullForceStart * Time.deltaTime;
    ...
    private void OnMouseDrag()
    {
        ...
        {
            transform.position = Vector3.MoveTowards(transform.position, targetPosition, pullForce);    // Move towards mouse with pullforce.
            rb.gravityScale = 0;
        }
    }
    ...
    private void OnMouseUp()    // releasing mouse re enables the grabbing and gravity.
    {
        ...
        private void OnCollisionEnter(Collision collision){ // Check collision, if you are allowed to move.
